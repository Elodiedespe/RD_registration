...
if __name__ == "__main__":
    ...
    template_2 = os.path.join(ATLAS_PATH, "atlas_0-2/ANTS2-0Years_brain_bias_corrected.nii.gz")
    labels_2 = os.path.join(ATLAS_PATH, "atlas_0-2/ANTS2-0Years_brain_ANTS_LPBA40_atlas.nii.gz")
    template_5 = os.path.join(ATLAS_PATH, "atlas_5_9/ANTS9-5Years3T_brain.nii.gz")
    labels_5 = os.path.join(ATLAS_PATH, "atlas_5_9/ANTS9-5Years3T_brain_ANTS_LPBA40_atlas.nii.gz")
    template_2_5 = os.path.join(ATLAS_PATH, "atlas_2_5/ANTS2-5Years_brain_bias_corrected.nii.gz")
