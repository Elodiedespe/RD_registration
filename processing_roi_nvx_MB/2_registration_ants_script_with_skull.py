...
if __name__ == "__main__":
    ...
    # MAIN PATH
    ROOT_PATH = "/home/edogerde/Bureau/MB_10"
    ...
    # get the t1
    files = glob.glob(os.path.join(ROOT_PATH, 'results', 'sujet*', "im_reorient.nii.gz"))
    files.sort()
    results = []
    ...
    for f in files:
        ...
        subjects_csv = os.path.join(ROOT_PATH, "flipfileNMB.csv")
